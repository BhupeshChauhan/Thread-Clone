...
const TabsContent = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_radix_ui_react_tabs__WEBPACK_IMPORTED_MODULE_2__/* .Content */ .VY, {
        ref: ref,
        className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_3__.cn)("mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-800", className),
        ...props
    }));
...
/* harmony import */ var _lib_actions_community_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93040);
/* harmony import */ var _lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18776);
/* harmony import */ var _cards_ThreadCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13312);
...
async function ThreadsTab({ currentUserId, accountId, accountType }) {
    ...
    if (accountType === "Community") {
        result = await (0,_lib_actions_community_actions__WEBPACK_IMPORTED_MODULE_2__.fetchCommunityPosts)(accountId);
    } else {
        result = await (0,_lib_actions_user_actions__WEBPACK_IMPORTED_MODULE_3__.fetchUserPosts)(accountId);
    }
    if (!result) {
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("section", {
        ...
        children: result.threads.map((thread)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_cards_ThreadCard__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                id: thread._id,
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/bhupeshsinghchauhan/Documents/GitHub/Thread-Clone/components/ui/tabs.tsx`)
