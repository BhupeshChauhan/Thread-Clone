...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6457)), "/Users/bhupeshsinghchauhan/Documents/GitHub/Thread-Clone/app/(root)/thread/[id]/page.tsx"],
        ...
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 57109)), "/Users/bhupeshsinghchauhan/Documents/GitHub/Thread-Clone/app/(root)/layout.tsx"],
...
const pages = ["/Users/bhupeshsinghchauhan/Documents/GitHub/Thread-Clone/app/(root)/thread/[id]/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(root)/thread/[id]/page";
const __next_app__ = {
...
'ac51670028c29e7849b513f1979db83e8294c5f3': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71478)).then(mod => mod["fetchPosts"]),
'4b27cfcbfb8cd73d5558d1192a7d630e2ff5a87b': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71478)).then(mod => mod["createThread"]),
'7bef3064424aefb8e0e8f63d4602b5c828fc0660': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71478)).then(mod => mod["deleteThread"]),
'13e555ed7825e96044848b10c5c4bd490494900b': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71478)).then(mod => mod["fetchThreadById"]),
'7a9374a1c2ba267143725d2f9e61a3bf0a6618ef': () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71478)).then(mod => mod["addCommentToThread"]),
}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 79636));
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13302))
...
/* harmony import */ var _hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(83894);
/* harmony import */ var _components_ui_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1753);
/* harmony import */ var _ui_input__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5538);
/* harmony import */ var _ui_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(44368);
/* harmony import */ var _lib_validations_thread__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(91555);
/* harmony import */ var _lib_actions_thread_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(99805);
...
function Comment({ threadId, currentUserImg, currentUserId }) {
    ...
    const form = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_8__/* .useForm */ .cI)({
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_9__/* .zodResolver */ .F)(_lib_validations_thread__WEBPACK_IMPORTED_MODULE_6__/* .CommentValidation */ .g),
        defaultValues: {
            thread: ""
        }
    });
    const onSubmit = async (values)=>{
        await (0,_lib_actions_thread_actions__WEBPACK_IMPORTED_MODULE_7__/* .addCommentToThread */ .Ho)(threadId, values.thread, JSON.parse(currentUserId), pathname);
        form.reset();
    };
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_form__WEBPACK_IMPORTED_MODULE_3__/* .Form */ .l0, {
        ...form,
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
            className: "comment-form",
            onSubmit: form.handleSubmit(onSubmit),
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_form__WEBPACK_IMPORTED_MODULE_3__/* .FormField */ .Wi, {
                    control: form.control,
                    name: "thread",
                    render: ({ field })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_ui_form__WEBPACK_IMPORTED_MODULE_3__/* .FormItem */ .xJ, {
                            className: "flex w-full items-center gap-3",
                            children: [
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_form__WEBPACK_IMPORTED_MODULE_3__/* .FormLabel */ .lX, {
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_form__WEBPACK_IMPORTED_MODULE_3__/* .FormControl */ .NI, {
                                    className: "border-none bg-transparent",
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_ui_input__WEBPACK_IMPORTED_MODULE_4__/* .Input */ .I, {
                                        type: "text",
                                        ...field,
                                        placeholder: "Comment...",
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_ui_button__WEBPACK_IMPORTED_MODULE_5__/* .Button */ .z, {
                    type: "submit",
...
;// CONCATENATED MODULE: ./components/forms/Comment.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/Users/bhupeshsinghchauhan/Documents/GitHub/Thread-Clone/components/forms/Comment.tsx`)
...
/* harmony default export */ const Comment = (__default__);
// EXTERNAL MODULE: ./components/cards/ThreadCard.tsx + 1 modules
var ThreadCard = __webpack_require__(13312);
// EXTERNAL MODULE: ./lib/actions/user.actions.ts
var user_actions = __webpack_require__(18776);
// EXTERNAL MODULE: ./lib/actions/thread.actions.ts
var thread_actions = __webpack_require__(71478);
;// CONCATENATED MODULE: ./app/(root)/thread/[id]/page.tsx
...
async function page({ params }) {
    ...
    if (!user) return null;
    const userInfo = await (0,user_actions.fetchUser)(user.id);
    if (!userInfo?.onboarded) (0,navigation.redirect)("/onboarding");
    const thread = await (0,thread_actions.fetchThreadById)(params.id);
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("section", {
        className: "relative",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ jsx_runtime_.jsx(ThreadCard/* default */.Z, {
                    id: thread._id,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "mt-10",
                children: thread.children.map((childItem)=>/*#__PURE__*/ jsx_runtime_.jsx(ThreadCard/* default */.Z, {
                        id: childItem._id,
                        currentUserId: user.id,
...
var __webpack_exports__ = __webpack_require__.X(0, [3342,4813,4425,2961,3997,9841,8422,8516,3560,2369,3979,6882,672,561,5435,3040,653,4497,5839,1065,1753,1478], () => (__webpack_exec__(94366)));
